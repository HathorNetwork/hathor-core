...
**processing rate is ≈ 215 tx/s (≈ 4.7 ms per transaction)**. The per-stage breakdown (organic workload,
N = 500):
...
artifact of the genesis-parented workload, resolved by the organic tip-confirming DAG, not a property of
the node.)
