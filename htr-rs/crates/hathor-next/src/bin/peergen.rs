...
use hathor_next::crypto::KeygenParams;
use hathor_next::peer::{PeerAddress, PeerId, PrivatePeer};
...
enum VanitySearchError {
    ...
    KeyGeneration(#[from] hathor_next::peer::Error),
...
fn peer_id_matches(peer_id: &hathor_next::peer::PeerId, prefix: &[u8]) -> bool {
    if prefix.is_empty() {
        return true;
    }
...
mod tests {
    use super::*;
    use hathor_next::common::Hash32;
    use hathor_next::peer::PeerId;
