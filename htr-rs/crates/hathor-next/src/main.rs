...
struct Cli {
    ...
    listen: Option<Vec<hathor_next::peer::PeerAddress>>,
    #[arg(long, value_delimiter = ',', num_args = 1.., alias = "connect-to")]
    connect: Option<Vec<hathor_next::peer::PeerAddress>>,
...
fn main() -> Result<(), Error> {
    ...
    let _log_guard = hathor_next::logging::setup_logging_with_level_and_filters(
    ...
    hathor_next::crypto::install_default_crypto_provider();
    trace!("opts: {:?}", cli);
