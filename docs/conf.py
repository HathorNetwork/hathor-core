...
htmlhelp_basename = 'HathorNetworkdoc'
...
latex_documents = [
    (master_doc, 'HathorNetwork.tex', 'Hathor Network Documentation',
     'Hathor Team', 'manual'),
]
...
man_pages = [
    (master_doc, 'hathornetwork', 'Hathor Network Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'HathorNetwork', 'Hathor Network Documentation',
     author, 'HathorNetwork', 'One line description of project.',
     'Miscellaneous'),
]
