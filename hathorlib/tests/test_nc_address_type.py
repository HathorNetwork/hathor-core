...
class TestNCFee(unittest.TestCase):
    def test_htr_fee_value(self) -> None:
        ...
        self.assertEqual(fee.__get_htr_value__(settings, TokenAmountVersion.V1), TokenAmount.from_v1(100))
    ...
    def test_custom_token_fee_value(self) -> None:
        ...
        self.assertIsInstance(result, TokenAmount)
        self.assertGreater(result, TokenAmount.zero())
