...
class HathorSettings(BaseModel):
    ...
    @property
    def FEE_TOKEN_AMOUNT_PER_OUTPUT(self) -> TokenAmount:
        return TokenAmount.from_v1(self.FEE_PER_OUTPUT_V1)
    ...
    MAX_DISTANCE_BETWEEN_BLOCKS: int = 150 * 30  # AVG_TIME_BETWEEN_BLOCKS
    ...
    WEIGHT_DECAY_ACTIVATE_DISTANCE: int = 120 * 30  # AVG_TIME_BETWEEN_BLOCKS
    ...
    MAX_INPUTS_OUTPUTS_ADDRESS_HISTORY: int = 6 * 150  # MAX_TX_ADDRESSES_HISTORY
