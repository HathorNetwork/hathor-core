...
from hathorlib.serialization.encoding.output_value import encode_length_prefix_varint, decode_length_prefix_varint
...
class _LEB128NCType(_VarIntNCType):
    ...
    def _lower_bound_value(cls) -> int | None:
        ...
        if cls._max_byte_size is not None:
            return int(-(2**(cls._max_byte_size * 7)))
        else:
            return None
...
# class VarInt32NCType(_LPENCType):
#     """Variable-size signed integer with at most 32 bytes, effectively 223 bits + sign bit.
#     """
#
#     _signed = True
...
#
#
# class VarUint32NCType(_LPENCType):
#     """Variable-size unsigned integer with at most 32 bytes.
#     """
#
#     _signed = False
