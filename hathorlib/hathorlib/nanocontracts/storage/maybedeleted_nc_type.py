...
from hathorlib.nanocontracts.storage.types import DeletedKey, DeletedKeyType
from hathorlib.serialization import Deserializer, Serializer
from hathorlib.serialization.encoding.bool import decode_bool
...
class MaybeDeletedNCType(NCType[T | DeletedKeyType]):
    ...
    def _serialize(self, serializer: Serializer, value: T | DeletedKeyType, /) -> None:
        from hathorlib.serialization.encoding.bool import encode_bool
