...
- Check how execution results are stored in the codebase (search for execution result types)
- **Look for a dry-run runner** — search for dry-run or simulate functionality that can replay the execution for debugging without committing state
