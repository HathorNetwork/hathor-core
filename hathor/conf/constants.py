...
MAXIMUM_NUMBER_OF_HALVINGS: int = int(log(INITIAL_TOKEN_UNITS_PER_BLOCK, 2) - log(MINIMUM_TOKEN_UNITS_PER_BLOCK, 2))
...
# Whether the event queue feature is enabled or not
ENABLE_EVENT_QUEUE_FEATURE: bool = False

# Default size of event batch in the event queue api
EVENT_API_DEFAULT_BATCH_SIZE: int = 100

# Max size of event batch in the event queue api
