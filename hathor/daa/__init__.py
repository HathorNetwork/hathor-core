...
Architecture:
    ...
    hathor.daa.v1       — DifficultyAdjustmentAlgorithmV1 (the original 30s target algorithm)
    hathor.daa.daa      — DifficultyAdjustmentAlgorithm (facade preserving the public API)
"""
