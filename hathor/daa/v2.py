...
"""DifficultyAdjustmentAlgorithmV2: Reduced target (7.5s default), reduced rewards."""
...
class DifficultyAdjustmentAlgorithmV2:
    """Reduced DAA with shorter block target and proportionally reduced rewards.
    ...
    def get_tokens_issued_per_block(self, height: int) -> int:
        """Return the reduced reward for a block at the given height."""
