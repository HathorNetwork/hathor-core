...
class RocksDBTokensIndex(TokensIndex, RocksDBIndexUtils):
    ...
    def create_token_info(
        ...
        *,
        ...
        symbol: str | None,
        version: TokenVersion | None,
        total: UnsignedAmount = UnsignedAmount.zero(),
    ...
    def _add_utxo(self, tx: BaseTransaction, index: int) -> None:
        ...
        if tx_output.is_token_authority():
            ...
            self.add_to_total(token_uid, tx_output.value.to_signed())
            ...
            for action in nano_header.nc_actions:
                ...
                match action.type:
                    case NCActionType.DEPOSIT:
                        self.add_to_total(token_uid, action.amount.to_signed())
