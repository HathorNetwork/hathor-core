...
class HathorManager:
    ...
    def generate_mining_block(self, timestamp: Optional[float] = None,
        ...
        blk = Block(version=version, outputs=tx_outputs, parents=parents, storage=self.tx_storage, data=data)
    ...
    def calculate_block_difficulty(self, block: Block) -> float:
        ...
        n_target = settings.BLOCK_DIFFICULTY_N_BLOCKS
        max_depth = settings.BLOCK_DIFFICULTY_MAX_DEPTH
