...
class TransactionVerifier:
    ...
    def verify_sigops_input(self, tx: Transaction, storage: SimpleMemoryStorage) -> None:
        ...
        for tx_input in tx.inputs:
            try:
                spent_tx = storage.get_vertex(tx_input.tx_id)
    ...
    def verify_inputs(self, tx: Transaction, storage: SimpleMemoryStorage, *, skip_script: bool = False) -> None:
