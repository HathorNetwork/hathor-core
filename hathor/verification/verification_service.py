...
class VerificationService:
    ...
    def _verify_basic_shielded_header(self, tx: Transaction) -> None:
        ...
        try:
            ...
            self.verifiers.shielded_tx.log.warning('shielded basic verification failed', tx=tx.hash_hex)
            raise
    ...
    def _verify_shielded_header(self, tx: Transaction) -> None:
        ...
        try:
            self.verifiers.shielded_tx.verify_shielded_outputs_with_storage(tx)
        except Exception:
            self.verifiers.shielded_tx.log.warning('shielded full verification failed', tx=tx.hash_hex)
            raise
    ...
    def _verify_tx(
        ...
        *,
        ...
        if (
            ...
            shielded_fee = ShieldedTransactionVerifier.calculate_shielded_fee(self._settings, tx)
            self.verifiers.shielded_tx.verify_no_mint_melt(_token_dict)
