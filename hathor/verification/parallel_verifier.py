...
class ParallelVerifier:
    ...
    async def validate_full(self, vertex: Vertex, *, reject_locked_reward: bool) -> bool:
        ...
        if not missing_deps:
            ...
            self._reactor.callLater(0, lambda: Deferred.fromCoroutine(self._finish(vertex.hash, deferred)))
        else:
    ...
    async def _finish(self, vertex_id: VertexId, deferred: Deferred[None]) -> None:
