...
class AsyncP2PVertexHandler(P2PVertexHandler):
    ...
    """
    __slots__ = ('_log', '_reactor', '_settings', '_p2p_storage', '_vertex_count')
    ...
    async def _handle_new_vertex(
        ...
        *,
        ...
        result = False
        self._log.debug(f'received vertex {current_count}', hash=vertex.hash_hex, handler=self)
        ...
        try:
            ...
            self._log.debug(f'completed vertex {current_count}/{self._vertex_count}', hash=vertex.hash_hex)
