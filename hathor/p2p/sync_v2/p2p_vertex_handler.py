...
class AsyncP2PVertexHandler(P2PVertexHandler):
    ...
    def handle_new_vertex(
        ...
        *,
        ...
        self._new_vertex_queue.append(_NewVertex(vertex, fails_silently, propagate_to_peers, deferred), is_sync_v2=True)
        # TODO: init static meta. here or in the storage?
