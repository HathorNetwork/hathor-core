...
class NodeBlockSync(SyncAgent):
    ...
    def run_sync_blocks(self) -> Generator[Any, Any, bool]:
        ...
        if self.peer_best_block.height <= my_best_block.height:
            ...
            common_block_hash = self.p2p_storage.get_block_by_height(self.peer_best_block.height)
    ...
    def handle_tips(self, payload: str) -> None:
        ...
        self._receiving_tips.extend(tx_id for tx_id in data if not self.p2p_storage.partial_vertex_exists(tx_id))
    ...
    def handle_data(self, payload: str) -> None:
        ...
        if self.p2p_storage.partial_vertex_exists(tx.hash):
