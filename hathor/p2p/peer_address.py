...
class PeerAddress:
    """Peer address as received when a connection is made or from a DNS query."""
    ...
    def with_id(self, peer_id: PeerId | None = None) -> PeerAddressAndId:
        return PeerAddressAndId(self, peer_id)


@dataclass(frozen=True, slots=True)
class PeerAddressAndId:
    """Endpoint description as received from the p2p network, may contain a peer-id."""
    addr: PeerAddress
    ...
    @classmethod
    def parse(cls, description: str) -> PeerAddressAndId:
        """Parse endpoint description into an Entrypoint object.

        Examples:

        >>> str(PeerAddressAndId.parse('tcp://127.0.0.1:40403/'))
        'tcp://127.0.0.1:40403'

        >>> id1 = 'c0f19299c2a4dcbb6613a14011ff07b63d6cb809e4cee25e9c1ccccdd6628696'
        >>> PeerAddressAndId.parse(f'tcp://127.0.0.1:40403/?id={id1}')
        PeerAddressAndId(addr=PeerAddress(protocol=<Protocol.TCP: 'tcp'>, host='127.0.0.1', port=40403), \
peer_id=PeerId('c0f19299c2a4dcbb6613a14011ff07b63d6cb809e4cee25e9c1ccccdd6628696'))

        >>> str(PeerAddressAndId.parse(f'tcp://127.0.0.1:40403/?id={id1}'))
        'tcp://127.0.0.1:40403/?id=c0f19299c2a4dcbb6613a14011ff07b63d6cb809e4cee25e9c1ccccdd6628696'

        >>> PeerAddressAndId.parse('tcp://127.0.0.1:40403')
        PeerAddressAndId(addr=PeerAddress(protocol=<Protocol.TCP: 'tcp'>, host='127.0.0.1', port=40403), peer_id=None)

        >>> PeerAddressAndId.parse('tcp://127.0.0.1:40403/')
        PeerAddressAndId(addr=PeerAddress(protocol=<Protocol.TCP: 'tcp'>, host='127.0.0.1', port=40403), peer_id=None)

        >>> PeerAddressAndId.parse('tcp://foo.bar.baz:40403/')
        PeerAddressAndId(addr=PeerAddress(protocol=<Protocol.TCP: 'tcp'>, host='foo.bar.baz', port=40403), \
peer_id=None)

        >>> str(PeerAddressAndId.parse('tcp://foo.bar.baz:40403/'))
        'tcp://foo.bar.baz:40403'

        >>> PeerAddressAndId.parse('tcp://127.0.0.1:40403/?id=123')
        Traceback (most recent call last):
        ...
        ValueError: non-hexadecimal number found in fromhex() arg at position 3

        >>> PeerAddressAndId.parse('tcp://127.0.0.1:4040f')
        Traceback (most recent call last):
        ...
        ValueError: Port could not be cast to integer value as '4040f'

        >>> PeerAddressAndId.parse('udp://127.0.0.1:40403/')
        Traceback (most recent call last):
        ...
        ValueError: 'udp' is not a valid Protocol

        >>> PeerAddressAndId.parse('tcp://127.0.0.1/')
        Traceback (most recent call last):
        ...
        ValueError: expected a port: "tcp://127.0.0.1/"

        >>> PeerAddressAndId.parse('tcp://:40403/')
        Traceback (most recent call last):
        ...
        ValueError: expected a host: "tcp://:40403/"

        >>> PeerAddressAndId.parse('tcp://127.0.0.1:40403/foo')
        Traceback (most recent call last):
        ...
        ValueError: unexpected path: "tcp://127.0.0.1:40403/foo"

        >>> id2 = 'bc5119d47bb4ea7c19100bd97fb11f36970482108bd3d45ff101ee4f6bbec872'
        >>> PeerAddressAndId.parse(f'tcp://127.0.0.1:40403/?id={id1}&id={id2}')
        Traceback (most recent call last):
        ...
    ...
    def equals_ignore_peer_id(self, other: Self) -> bool:
        ...
        >>> PeerAddressAndId.parse(ep1).equals_ignore_peer_id(PeerAddressAndId.parse(ep2))
        True
        >>> PeerAddressAndId.parse(ep2).equals_ignore_peer_id(PeerAddressAndId.parse(ep3))
        True
        >>> PeerAddressAndId.parse(ep1).equals_ignore_peer_id(PeerAddressAndId.parse(ep4))
        False
        >>> PeerAddressAndId.parse(ep2).equals_ignore_peer_id(PeerAddressAndId.parse(ep4))
        False
        >>> PeerAddressAndId.parse(ep2).equals_ignore_peer_id(PeerAddressAndId.parse(ep5))
        False
        >>> PeerAddressAndId.parse(ep6).equals_ignore_peer_id(PeerAddressAndId.parse(ep7))
        True
        """
