...
from hathor.nanocontracts.nc_failure import NCMethodNotFound, NCResult


def parse_nc_method_call(blueprint_class: type[Blueprint], call_info: str) -> NCResult[tuple[str, Any]]:
    ...
    if method_callable is None:
        return NCMethodNotFound(f'{blueprint_class.__name__}.{method_name}').to_result()
    ...
    return Success((method_name, parsed_args))
