...
# The whole serialization system makes extensive use of these 3 exception types which can be
# triggered by user input. Any other exception type will not be handled and therefore will
# be considered a bug, crashing the full node. Ideally, we should refactor all of it to use
# `Result`, too. For now, we simply handle them here.
