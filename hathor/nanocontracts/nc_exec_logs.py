...
class NCLogEntry(_BaseNCEntry):
    """An entry representing a single log in an NC execution."""
...
class NCCallBeginEntry(_BaseNCEntry):
    """An entry representing a single method call beginning in an NC execution."""
    ...
    def from_call_record(call_record: CallRecord, *, timestamp: float) -> NCCallBeginEntry:
        ...
        return NCCallBeginEntry(
            nc_id=call_record.nanocontract_id,
...
class NCCallEndEntry(_BaseNCEntry):
    """An entry representing a single method call ending in an NC execution."""
...
class NCExecEntry(BaseModel):
    ...
    def from_call_info(call_info: CallInfo, error_tb: str | None) -> NCExecEntry:
        """Create a NCExecEntry from a CallInfo, an optional traceback, and the time of execution."""
        return NCExecEntry(
