...
NCDryRunResource.openapi = {
    '/nano_contract/dry_run': {
        'x-visibility': 'public',
        'x-rate-limit': {
            'global': [
                {
        ...
        'get': {
            'tags': ['nano_contracts'],
            'operationId': 'nano_contracts_dry_run',
            ...
            'parameters': [
                {
                    'name': 'block_hash',
                    'in': 'query',
                    'description': 'Hash of the block to dry-run',
                    'required': False,
                    'schema': {
                        'type': 'string'
                    }
                },
                {
                    'name': 'tx_hash',
                    'in': 'query',
                    'description': 'Hash of the NC transaction (will dry-run its first_block)',
                    'required': False,
                    'schema': {
                        'type': 'string'
                    }
                },
                {
                    ...
                    'in': 'query',
                    'description': 'Include storage state changes in call records',
                    'required': False,
                    'schema': {
                        'type': 'boolean',
                        'default': False
                            ...
                            'examples': {
                                'success': {
                                    ...
                                    'value': {
                                        ...
                                        'block_hash': '0000abc...',
                                        'block_height': 12345,
                                        'initial_block_root_id': 'deadbeef...',
                                        'final_block_root_id': 'cafebabe...',
                                        'expected_block_root_id': 'cafebabe...',
                                        'root_id_matches': True,
                                        'nc_sorted_calls': ['tx1_hash', 'tx2_hash'],
                                        'transactions': [
                                            {
                                                'tx_hash': 'tx1_hash',
                                                'rng_seed': 'aabbcc...',
