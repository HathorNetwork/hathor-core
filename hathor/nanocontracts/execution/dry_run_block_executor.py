...
class DryRunTxResult(Response):
    ...
    tx_hash: str
    rng_seed: str
    execution_status: str  # 'success', 'failure', 'skipped'
    call_records: list[DryRunCallRecord] = []
...
class DryRunResult(Response):
    ...
    block_hash: str
    block_height: int
    initial_block_root_id: str
    final_block_root_id: str
    expected_block_root_id: str
