...
class DequeStorageContainer(StorageContainer, MutableSequence[T]):
    ...
    # this method of deque doesn't take slices, unlike MutableSequence, hence the type: ignores
    def __getitem__(self, index: SupportsIndex, /) -> T:  # type: ignore[override]
    ...
    # Methods provided by MutableSequence:
