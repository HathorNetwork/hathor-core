...
from typing import TYPE_CHECKING, Callable, Generic, ParamSpec, Protocol, TypeVar
...
class CreateWithRunner(Protocol[P, T]):
    """Create a lazy import from the provided Runner."""
    def __call__(self, runner: Runner) -> Callable[P, T]:
        ...
...
class LazyImport(Generic[P, T]):
    ...
    def __init__(self, name: str, create_func: CreateWithRunner[P, T]) -> None:
        self.__name = name
