...
if TYPE_CHECKING:
    ...
    from hathor.nanocontracts.runner.index_records import NCIndexUpdateRecord, nc_index_update_record_to_json
...
class MetaNCCallRecord:
    ...
    def to_json(self) -> dict[str, Any]:
        ...
        return dict(
            ...
            index_updates=[nc_index_update_record_to_json(record) for record in self.index_updates]
        )
