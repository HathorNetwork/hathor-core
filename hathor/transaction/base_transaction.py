...
class TxOutput:
    ...
    def __str__(self) -> str:
        ...
        value_str = hex(self.value.raw()) if self.is_token_authority() else str(self.value.normalized())
        if self.token_data:
    ...
    def to_human_readable(self) -> dict[str, Any]:
        ...
        if script_type:
            ...
            # `value` is in the output's native decimal version, matching `to_json`.
            ret['value'] = self.value.raw()
