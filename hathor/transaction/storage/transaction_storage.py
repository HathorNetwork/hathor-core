...
class TransactionStorage(ABC):
    ...
    def get_weight_best_block(self) -> float:
        return self.get_best_block().weight
    ...
    def get_blueprint_class(
        ...
        if isinstance(blueprint, OnChainBlueprint):
            ...
            if not skip_loading_cost and blueprint._blueprint_cache is not None:
                loading_cost = blueprint._blueprint_cache.loading_costs or None
