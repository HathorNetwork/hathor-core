...
class Features:
    ...
    def get_settings(settings: HathorSettings) -> dict[Feature, FeatureSetting]:
        ...
        return {
            ...
            Feature.TWO_TIER_FINALITY: settings.ENABLE_TWO_TIER_FINALITY,
        }
    ...
    def from_vertex(*, settings: HathorSettings, feature_service: FeatureService, vertex: Vertex) -> Features:
        ...
        return Features(
            ...
            two_tier_finality=feature_is_active[Feature.TWO_TIER_FINALITY],
        )
    ...
    def for_mempool(*, settings: HathorSettings, feature_service: FeatureService, best_block: Block) -> Features:
        ...
        return Features(
            ...
            two_tier_finality=features.two_tier_finality,
