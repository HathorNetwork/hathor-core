...
class Features:
    ...
    def from_vertex(*, settings: HathorSettings, feature_service: FeatureService, vertex: Vertex) -> Features:
        ...
        is_decimal_version_v2_active = feature_is_active[Feature.TOKEN_AMOUNT_V2]
        token_amount_version = TokenAmountVersion.V2 if is_decimal_version_v2_active else TokenAmountVersion.V1
