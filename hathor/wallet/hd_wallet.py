...
from hathor.crypto.util import get_private_key_from_bytes, get_address_b58_from_public_key_bytes
...
class HDWallet(BaseWallet):
    ...
    def _manually_initialize(self):
        ...
        # Account Node should be hardened
        self.acc_key = key.ChildKey(0 + BIP32_HARDEN)
    ...
    def get_private_key(self, address58):
        ...
        return get_private_key_from_bytes(my_key.k.to_der())
    ...
    def generate_new_key(self, index):
        """ Generate a new key in the tree at defined index
            ...
            :type index: int
        """
        new_key = self.acc_key.ChildKey(index)
    ...
    def get_address(self, new_key):
        ...
        return get_address_b58_from_public_key_bytes(new_key.K.to_der())
    ...
    def get_key_at_index(self, index):
        """ Return the key generated by the index in the parameter
            ...
            :type index: int
        """
        return self.acc_key.ChildKey(index)
    ...
    def tokens_received(self, address58):
        ...
        diff = self.last_generated_index - received_key.index
        ...
        self.last_shared_index = max(self.last_shared_index, received_key.index + 1)
