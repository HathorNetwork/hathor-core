...
'''
        ...
        # Verify costs are stored in cache
        self.assertIsNotNone(ocb._blueprint_cache)
        cached_costs = ocb._blueprint_cache.loading_costs
...
'''
        ...
        # Verify cache exists but loading_costs is zero
        self.assertIsNotNone(ocb._blueprint_cache)
        self.assertEqual(ocb._blueprint_cache.loading_costs, SandboxCounts())
...
'''
        ...
        cached_loading_cost = ocb._blueprint_cache.loading_costs.operation_count
...
'''
        ...
        # Load OCB1 fresh and get its loading cost from cache
        ocb1.get_blueprint_class(MeteredExecutor(config=sandbox_config))
        ocb1_fresh_cost = ocb1._blueprint_cache.loading_costs.operation_count

        # Load OCB2 fresh first (to populate cache)
        ocb2.get_blueprint_class(MeteredExecutor(config=sandbox_config))
        ocb2_fresh_cost = ocb2._blueprint_cache.loading_costs.operation_count
...
'''
        ...
        ocb1_cost = ocb1._blueprint_cache.loading_costs.operation_count
        ocb2_cost = ocb2._blueprint_cache.loading_costs.operation_count
...
'''
        ...
        self.assertIsNotNone(ocb._blueprint_cache)
        loading_cost = ocb._blueprint_cache.loading_costs.operation_count
...
'''
        ...
        self.assertIsNotNone(ocb._blueprint_cache)
        loading_costs = ocb._blueprint_cache.loading_costs
