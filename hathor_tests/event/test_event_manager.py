...
class EventManagerTest(unittest.TestCase):
    ...
    def test_nc_token_creation_event_missing_token(self) -> None:
        ...
        self.assertEqual(token_data.initial_amount, 100)
        ...
        self.assertIsNotNone(call_meta.first_block)
        if call_meta.first_block is not None:
    ...
    def test_token_creation_transaction_emits_token_created_event(self) -> None:
        ...
        self.assertEqual(token_data.initial_amount, mint_amount)
        self.assertEqual(token_data.token_version, TokenVersion.DEPOSIT)
