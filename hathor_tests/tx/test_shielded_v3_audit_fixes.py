...
class TestV3001StreamingClientFeatureGate:
    """V3-001: Streaming client must enable shielded_transactions=True."""

    def test_streaming_client_enables_shielded(self) -> None:
        """The streaming client VerificationParams must not disable shielded transactions."""
        ...
        assert 'shielded_transactions=True' in source, \
            'V3-001 regression: streaming client must set shielded_transactions=True'
