...
class TestEphemeralPubkeySerialization:
    ...
    def test_sighash_includes_ephemeral_pubkey(self) -> None:
        ...
        assert s1 != s2
        # The sighash with ephemeral pubkey should be 33 bytes longer
        assert len(s2) == len(s1) + 33
