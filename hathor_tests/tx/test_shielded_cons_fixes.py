...
"""TDD tests for consolidated security audit findings.
...
def _make_service_and_mocks():
    ...
    tx_verifier = TransactionVerifier(settings=settings, daa_factory=MagicMock(), feature_service=MagicMock())
...
# ============================================================================
# Verify_sum bypass — authority/deposit/fee checks must still run
# ============================================================================
...
# ============================================================================
# _get_token_info_from_inputs crash on shielded input spend
# ============================================================================

class TestGetTokenInfoFromInputsCrash:
...
class TestTokenCreationShielded:
    ...
    def test_token_creation_allows_shielded_header_when_feature_on(self) -> None:
        ...
        from hathor.transaction import TxVersion
        from hathor.transaction.headers import MeltHeader, MintHeader, ShieldedOutputsHeader, UnshieldBalanceHeader
        from hathor.verification.vertex_verifier import VertexVerifier
        ...
        # A creation tx mints its new token; it never melts, so no MeltHeader on a TCT.
        assert MeltHeader not in allowed


# ============================================================================
# Shielded output scripts not counted in verify_sigops_output
# ============================================================================

class TestSigopsOutputShielded:
...
# ============================================================================
# Script_eval missing bounds check for shielded index
# ============================================================================

class TestScriptEvalBoundsCheck:
...
# ============================================================================
# Surjection uses raw token_data without authority bit masking
# ============================================================================

class TestSurjectionTokenDataMasking:
...
# ============================================================================
# resolve_spent_output() and is_shielded_output() helpers + get_related_addresses
# ============================================================================

class TestResolveSpentOutput:
...
# ============================================================================
# utxo_index crashes on shielded input spend
# ============================================================================

class TestUtxoIndexShielded:
...
# ============================================================================
# to_json_extended crashes on shielded input spend
# ============================================================================
...
# ============================================================================
# address_balance crashes on shielded input spend
# ============================================================================
...
class TestAddressBalance:
    ...
    def test_skips_shielded_input_without_crash(self) -> None:
        ...
        for tx_in in tx.inputs:
            ...
            # This is the line that crashes — fix should skip shielded
...
# ============================================================================
# address_search crashes on shielded input spend
# ============================================================================
...
# ============================================================================
# base_wallet.py crashes on shielded input spend
# ============================================================================
...
# ============================================================================
# vertex_data _get_txin_output crashes on shielded index
# ============================================================================
