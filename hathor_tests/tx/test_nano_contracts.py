...
class NanoContracts(unittest.TestCase):
    def test_match_values(self):
        ...
        spent_tx = Transaction(outputs=[TxOutput(TokenAmount.from_v1(20), script)])
        tx = Transaction(outputs=[TxOutput(TokenAmount.from_v1(20), P2PKH.create_output_script(address))])
