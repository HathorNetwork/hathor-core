...
from hathorlib.crypto.shielded import create_range_proof, derive_asset_tag
...
class TestWalletShieldedOutputRecovery:
    ...
    def _enable_shielded_transactions(self):
        """Wallet recovery is gated behind ENABLE_SHIELDED_TRANSACTIONS; enable it for these tests."""
        from unittest.mock import MagicMock, patch
        settings = MagicMock()
        settings.ENABLE_SHIELDED_TRANSACTIONS = True
        with patch('hathor.wallet.base_wallet.get_global_settings', return_value=settings):
            yield
