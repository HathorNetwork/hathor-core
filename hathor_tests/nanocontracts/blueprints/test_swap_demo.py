...
class SwapDemoTestCase(BlueprintTestCase):
    def setUp(self):
        ...
        self.blueprint_service.register_blueprint(self.blueprint_id, SwapDemo)
    ...
    def test_lifecycle(self) -> None:
        ...
        # Assert:
        self.assertEqual(
            Balance(value=TokenAmount.from_v1(100_00).to_balance(), can_mint=False, can_melt=False),
        ...
        # Assert:
        self.assertEqual(
            Balance(value=TokenAmount.from_v1(120_00).to_balance(), can_mint=False, can_melt=False),
            self.nc_storage.get_balance(self.token_a),
        )
        self.assertEqual(
            Balance(value=TokenAmount.from_v1(80_00).to_balance(), can_mint=False, can_melt=False),
            self.nc_storage.get_balance(self.token_b),
        )
