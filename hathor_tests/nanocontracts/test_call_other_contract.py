...
class NCBlueprintTestCase(BlueprintTestCase):
    ...
    def test_getting_funds_from_another_contract(self) -> None:
        ...
        self.assertEqual(
            Balance(
               value=TokenAmount.from_v1(11).to_balance(), can_mint=False, can_melt=False
           ), self.runner.get_current_balance(self.nc1_id, token1_uid)
        )
        self.assertEqual(
            Balance(
               value=TokenAmount.from_v1(12).to_balance(), can_mint=False, can_melt=False
           ), self.runner.get_current_balance(self.nc1_id, token2_uid)
        )
        self.assertEqual(
            Balance(
               value=TokenAmount.from_v1(13).to_balance(), can_mint=False, can_melt=False
        ...
        self.assertEqual(
            Balance(
               value=TokenAmount.from_v1(21).to_balance(), can_mint=False, can_melt=False
           ), self.runner.get_current_balance(self.nc2_id, token1_uid)
        )
        self.assertEqual(
            Balance(
               value=TokenAmount.from_v1(22).to_balance(), can_mint=False, can_melt=False
           ), self.runner.get_current_balance(self.nc2_id, token2_uid)
        )
        self.assertEqual(
            Balance(
               value=TokenAmount.from_v1(23).to_balance(), can_mint=False, can_melt=False
        ...
        self.assertEqual(
            Balance(
               value=TokenAmount.from_v1(31).to_balance(), can_mint=False, can_melt=False
           ), self.runner.get_current_balance(self.nc3_id, token1_uid)
        )
        self.assertEqual(
            Balance(
               value=TokenAmount.from_v1(32).to_balance(), can_mint=False, can_melt=False
           ), self.runner.get_current_balance(self.nc3_id, token2_uid)
        )
        self.assertEqual(
            Balance(
               value=TokenAmount.from_v1(33).to_balance(), can_mint=False, can_melt=False
        ...
        self.assertEqual(
            Balance(
               value=TokenAmount.from_v1(4).to_balance(), can_mint=False, can_melt=False
           ), self.runner.get_current_balance(self.nc1_id, token1_uid)
        )
        self.assertEqual(
            Balance(
        ...
        self.assertEqual(
            Balance(
               value=TokenAmount.from_v1(16).to_balance(), can_mint=False, can_melt=False
           ), self.runner.get_current_balance(self.nc2_id, token2_uid)
        )
        self.assertEqual(
            Balance(
    ...
    def test_transfer_between_contracts(self) -> None:
        ...
        self.assertEqual(
            Balance(
               value=TokenAmount.from_v1(49).to_balance(), can_mint=False, can_melt=False
           ), self.runner.get_current_balance(self.nc1_id, token1_uid)
        )
        self.assertEqual(
            Balance(
               value=TokenAmount.from_v1(24).to_balance(), can_mint=False, can_melt=False
           ), self.runner.get_current_balance(self.nc1_id, token2_uid)
        )
        self.assertEqual(
            Balance(
        ...
        self.assertEqual(
            Balance(
               value=TokenAmount.from_v1(25).to_balance(), can_mint=False, can_melt=False
           ), self.runner.get_current_balance(self.nc2_id, token1_uid)
        )
        self.assertEqual(
            Balance(
        ...
        self.assertEqual(
            Balance(
               value=TokenAmount.from_v1(6).to_balance(), can_mint=False, can_melt=False
           ), self.runner.get_current_balance(self.nc2_id, token3_uid)
        )

        self.assertEqual(
            Balance(
               value=TokenAmount.from_v1(26).to_balance(), can_mint=False, can_melt=False
           ), self.runner.get_current_balance(self.nc3_id, token1_uid)
        )
        self.assertEqual(
            Balance(
               value=TokenAmount.from_v1(14).to_balance(), can_mint=False, can_melt=False
           ), self.runner.get_current_balance(self.nc3_id, token2_uid)
        )
        self.assertEqual(
            Balance(
               value=TokenAmount.from_v1(7).to_balance(), can_mint=False, can_melt=False
           ), self.runner.get_current_balance(self.nc3_id, token3_uid)
        )
