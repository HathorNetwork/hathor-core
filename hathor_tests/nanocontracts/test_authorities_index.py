...
class TestAuthoritiesIndex(BlueprintTestCase):
    ...
    def test_grant_action_then_revoke(self) -> None:
        ...
        set_nano_header(
            ...
            nc_actions=[
                NanoHeaderAction(
                    ...
                    token_index=1,
                    amount=TokenAmount.from_v1(TxOutput.ALL_AUTHORITIES),
                )
            ],
        ...
        assert storage.get_balance(tka.hash) == Balance(
            value=TokenBalance(), can_mint=True, can_melt=True
        )
    ...
    def test_acquire_action_then_revoke(self) -> None:
        ...
        assert nc1_storage.get_balance(tka) == Balance(
            value=TokenAmount.from_v1(1000).to_balance(), can_mint=True, can_melt=True
        )
