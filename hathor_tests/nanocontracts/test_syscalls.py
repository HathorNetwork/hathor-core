...
class NCNanoContractTestCase(BlueprintTestCase):
    ...
    def test_authorities(self) -> None:
        ...
        assert storage.get_all_balances() == {
            htr_balance_key: Balance(value=TokenAmount.from_v1(1000).to_balance(), can_mint=False, can_melt=False),
        ...
        assert storage.get_all_balances() == {
            htr_balance_key: Balance(value=TokenAmount.from_v1(998).to_balance(), can_mint=False, can_melt=False),
            dbt_balance_key: Balance(value=TokenAmount.from_v1(1123).to_balance(), can_mint=True, can_melt=True),
        }

        # After melt
        self.runner.call_public_method(nc_id, 'melt', ctx, dbt_token_uid, 456)
        assert storage.get_all_balances() == {
            htr_balance_key: Balance(value=TokenAmount.from_v1(1002).to_balance(), can_mint=False, can_melt=False),
            dbt_balance_key: Balance(value=TokenAmount.from_v1(667).to_balance(), can_mint=True, can_melt=True),
        }
        ...
        assert storage.get_all_balances() == {
            htr_balance_key: Balance(value=TokenAmount.from_v1(1002).to_balance(), can_mint=False, can_melt=False),
            dbt_balance_key: Balance(value=TokenAmount.from_v1(667).to_balance(), can_mint=False, can_melt=True),
        }
        ...
        assert storage.get_all_balances() == {
            htr_balance_key: Balance(value=TokenAmount.from_v1(1002).to_balance(), can_mint=False, can_melt=False),
            dbt_balance_key: Balance(value=TokenAmount.from_v1(667).to_balance(), can_mint=False, can_melt=False),
        }
    ...
    def test_fee_token_creation(self) -> None:
        ...
        assert storage.get_all_balances() == {
            htr_balance_key: Balance(value=TokenAmount.from_v1(1).to_balance(), can_mint=False, can_melt=False),
            fbt_balance_key: Balance(value=TokenAmount.from_v1(1000000).to_balance(), can_mint=True, can_melt=True),
        }
        ...
        assert storage.get_all_balances() == {
            ...
            fbt_balance_key: Balance(value=TokenAmount.from_v1(1000000).to_balance(), can_mint=True, can_melt=True),
            dbt_balance_key: Balance(value=TokenAmount.from_v1(100).to_balance(), can_mint=True, can_melt=True),
        }
        ...
        assert storage.get_all_balances() == {
            htr_balance_key: Balance(value=TokenBalance(), can_mint=False, can_melt=False),
            fbt_balance_key: Balance(value=TokenAmount.from_v1(1000000).to_balance(), can_mint=True, can_melt=True),
            dbt_balance_key: Balance(value=TokenBalance(), can_mint=True, can_melt=True),
            fbt2_balance_key: Balance(value=TokenAmount.from_v1(1000000).to_balance(), can_mint=True, can_melt=True),
        }
    ...
    def test_fee_token_melt(self) -> None:
        ...
        assert storage.get_all_balances() == {
            htr_balance_key: Balance(value=TokenBalance(), can_mint=False, can_melt=False),
            fbt_balance_key: Balance(value=TokenAmount.from_v1(500000).to_balance(), can_mint=True, can_melt=True),
            dbt_balance_key: Balance(value=TokenBalance(), can_mint=True, can_melt=True),
        }
    ...
    def test_fee_token_mint(self) -> None:
        ...
        assert storage.get_all_balances() == {
            htr_balance_key: Balance(value=TokenBalance(), can_mint=False, can_melt=False),
            fbt_balance_key: Balance(value=TokenAmount.from_v1(1000000).to_balance(), can_mint=True, can_melt=True),
            dbt_balance_key: Balance(value=TokenAmount.from_v1(500).to_balance(), can_mint=True, can_melt=True),
        }
        ...
        assert storage.get_all_balances() == {
            htr_balance_key: Balance(value=TokenBalance(), can_mint=False, can_melt=False),
            fbt_balance_key: Balance(value=TokenAmount.from_v1(1100000).to_balance(), can_mint=True, can_melt=True),
            dbt_balance_key: Balance(value=TokenAmount.from_v1(400).to_balance(), can_mint=True, can_melt=True),
        }
        ...
        assert storage.get_all_balances() == {
            htr_balance_key: Balance(value=TokenBalance(), can_mint=False, can_melt=False),
            fbt_balance_key: Balance(value=TokenAmount.from_v1(1300000).to_balance(), can_mint=True, can_melt=True),
            dbt_balance_key: Balance(value=TokenAmount.from_v1(300).to_balance(), can_mint=True, can_melt=True),
        }
        ...
        assert storage.get_all_balances() == {
            htr_balance_key: Balance(value=TokenBalance(), can_mint=False, can_melt=False),
            fbt_balance_key: Balance(value=TokenAmount.from_v1(1450000).to_balance(), can_mint=True, can_melt=True),
            dbt_balance_key: Balance(value=TokenBalance(), can_mint=True, can_melt=True),
        }
    ...
    def test_fee_token_as_payment_rejected(self) -> None:
        ...
        assert storage.get_all_balances() == {
            htr_balance_key: Balance(value=TokenAmount.from_v1(9).to_balance(), can_mint=False, can_melt=False),
            ft1_balance_key: Balance(value=TokenAmount.from_v1(1000000).to_balance(), can_mint=True, can_melt=True),
        }
    ...
    def test_proxy_call_public_method_nc_args(self) -> None:
        ...
        assert target_storage.get_all_balances() == {
            htr_balance_key: Balance(value=TokenAmount.from_v1(10).to_balance(), can_mint=False, can_melt=False),
        }
        ...
        assert target_storage.get_all_balances() == {
            htr_balance_key: Balance(value=TokenAmount.from_v1(9).to_balance(), can_mint=False, can_melt=False),
            fbt_balance_key: Balance(value=TokenAmount.from_v1(20).to_balance(), can_mint=False, can_melt=False),
        }
