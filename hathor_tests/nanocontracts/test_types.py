...
from hathor.nanocontracts.types import ContractId, SignedDataV1, VertexId
...
class BaseNanoContractTestCase(unittest.TestCase):
    def test_signed(self) -> None:
        ...
        result = b'1x1'
        signed_result = SignedDataV1[bytes](result, b'')
        ...
        signed_result = SignedDataV1[bytes](result, script_input)
        ...
        invalid_signed_result = SignedDataV1[bytes](fake_result, script_input)
    ...
    def test_signed_eq(self):
        x = SignedDataV1[str]('data', b'signature')

        self.assertEqual(x, SignedDataV1[str]('data', b'signature'))
        self.assertNotEqual(x, SignedDataV1[str]('data', b'another-signature'))
        self.assertNotEqual(x, SignedDataV1[str]('another-data', 'signature'))
        self.assertNotEqual(x, SignedDataV1[str]('another-data', 'another-signature'))
