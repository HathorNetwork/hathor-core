...
import pytest
from htr_lib import TokenBalance
...
class NCActionsFeeTestCase(BlueprintTestCase):
    ...
    def test_actions_fee(self) -> None:
        ...
        # 100 - 10 - 1 = 89
        assert self.nc1_storage.get_all_balances() == {
            nc1_htr_balance_key: Balance(value=TokenAmount.from_v1(89).to_balance(), can_mint=False, can_melt=False),
            nc1_dbt_balance_key: Balance(value=TokenAmount.from_v1(1000).to_balance(), can_mint=True, can_melt=True),
            nc1_fbt_balance_key: Balance(value=TokenAmount.from_v1(10000).to_balance(), can_mint=True, can_melt=True),
        }
        ...
        assert self.nc1_storage.get_all_balances() == {
            nc1_htr_balance_key: Balance(value=TokenAmount.from_v1(88).to_balance(), can_mint=False, can_melt=False),
            nc1_dbt_balance_key: Balance(value=TokenAmount.from_v1(1000).to_balance(), can_mint=True, can_melt=True),
            nc1_fbt_balance_key: Balance(value=TokenAmount.from_v1(9000).to_balance(), can_mint=True, can_melt=True),
        }

        nc2_fbt_balance_key = BalanceKey(nc_id=self.nc2_id, token_uid=fbt_token_uid)
        assert self.nc2_storage.get_all_balances() == {
            nc2_fbt_balance_key: Balance(value=TokenAmount.from_v1(1000).to_balance(), can_mint=False, can_melt=False),
        }
        ...
        assert self.nc1_storage.get_all_balances() == {
            nc1_htr_balance_key: Balance(value=TokenAmount.from_v1(88).to_balance(), can_mint=False, can_melt=False),
            nc1_dbt_balance_key: Balance(value=TokenAmount.from_v1(900).to_balance(), can_mint=True, can_melt=True),
            nc1_fbt_balance_key: Balance(value=TokenAmount.from_v1(8000).to_balance(), can_mint=True, can_melt=True),
        }

        nc2_fbt_balance_key = BalanceKey(nc_id=self.nc2_id, token_uid=fbt_token_uid)
        assert self.nc2_storage.get_all_balances() == {
            nc2_fbt_balance_key: Balance(value=TokenAmount.from_v1(2000).to_balance(), can_mint=False, can_melt=False),
        }
        ...
        assert self.nc1_storage.get_all_balances() == {
            nc1_htr_balance_key: Balance(value=TokenAmount.from_v1(87).to_balance(), can_mint=False, can_melt=False),
            nc1_dbt_balance_key: Balance(value=TokenAmount.from_v1(900).to_balance(), can_mint=True, can_melt=True),
            nc1_fbt_balance_key: Balance(value=TokenAmount.from_v1(9000).to_balance(), can_mint=True, can_melt=True),
        }
        ...
        assert self.nc1_storage.get_all_balances() == {
            nc1_htr_balance_key: Balance(value=TokenAmount.from_v1(87).to_balance(), can_mint=False, can_melt=False),
            nc1_dbt_balance_key: Balance(value=TokenAmount.from_v1(800).to_balance(), can_mint=True, can_melt=True),
            nc1_fbt_balance_key: Balance(value=TokenAmount.from_v1(10_000).to_balance(), can_mint=True, can_melt=True),
        }

        nc2_fbt_balance_key = BalanceKey(nc_id=self.nc2_id, token_uid=fbt_token_uid)
        assert self.nc2_storage.get_all_balances() == {
            nc2_fbt_balance_key: Balance(value=TokenBalance(), can_mint=False, can_melt=False),
        }
    ...
    def test_create_and_actions(self) -> None:
        ...
        assert storage.get_all_balances() == {
            htr_balance_key: Balance(value=TokenBalance(), can_mint=False, can_melt=False),
            fbt_balance_key: Balance(value=TokenAmount.from_v1(900_000).to_balance(), can_mint=True, can_melt=True),
            ftt_balance_key: Balance(value=TokenAmount.from_v1(500_000).to_balance(), can_mint=True, can_melt=True),
            dbt_balance_key: Balance(value=TokenAmount.from_v1(1000).to_balance(), can_mint=True, can_melt=True),
        }
    ...
    def test_token_index_updates(self) -> None:
        ...
        assert fbt_token_info.get_total() == TokenAmount.from_v1(1_000_000)

        ftt_token_info = tokens_index.get_token_info(ftt_id)
        assert ftt_token_info.get_total() == TokenAmount.from_v1(500_000)

        dbt_token_info = tokens_index.get_token_info(dbt_id)
        assert dbt_token_info.get_total() == TokenAmount.from_v1(800)
        ...
        assert htr_token_info.get_total() == TokenAmount.from_v1(expected_htr_total)
        ...
        assert nc1_storage.get_balance(HATHOR_TOKEN_UID) == Balance(
            value=TokenAmount.from_v1(86).to_balance(), can_mint=False, can_melt=False
        )
        assert nc1_storage.get_balance(fbt_id) == Balance(
            value=TokenAmount.from_v1(997_000).to_balance(), can_mint=True, can_melt=True
        )
        assert nc1_storage.get_balance(ftt_id) == Balance(
            value=TokenAmount.from_v1(499_000).to_balance(), can_mint=True, can_melt=True
        )
        assert nc1_storage.get_balance(dbt_id) == Balance(
            value=TokenAmount.from_v1(800).to_balance(), can_mint=True, can_melt=True
        )
        ...
        assert nc2_storage.get_balance(HATHOR_TOKEN_UID) == Balance(
            value=TokenBalance(), can_mint=False, can_melt=False
        )
        assert nc2_storage.get_balance(fbt_id) == Balance(
            value=TokenAmount.from_v1(3000).to_balance(), can_mint=False, can_melt=False
        )
