...
class BuilderSandboxConfigLoaderTest(unittest.TestCase):
    ...
    def test_builder_get_or_create_sandbox_api_config_loader_returns_none_when_no_config_file(self) -> None:
        """Test that _get_or_create_sandbox_api_config_loader returns None when no config file."""
        mock_settings = Mock()
        mock_settings.ENABLE_NANO_CONTRACTS = True
        mock_settings.NC_SANDBOX_API_CONFIG_FILE = None
    ...
    def test_builder_get_or_create_sandbox_api_config_loader_creates_loader(self) -> None:
        """Test that _get_or_create_sandbox_api_config_loader creates loader when enabled."""
        yaml_content = """
api_view:
  enabled: true
...
"""
        ...
        try:
            mock_settings = Mock()
            mock_settings.ENABLE_NANO_CONTRACTS = True
            mock_settings.NC_SANDBOX_API_CONFIG_FILE = temp_path
