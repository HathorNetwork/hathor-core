...
class NCNanoContractTestCase(unittest.TestCase):
    ...
    def test_get_context(self) -> None:
        ...
        outputs = [
            TxOutput(TokenAmount.from_v1(100), b'', 0),  # HTR
            TxOutput(TokenAmount.from_v1(200), b'', 1),  # TOKEN A
            TxOutput(TokenAmount.from_v1(300), b'', 2),  # TOKEN B
        ]
        ...
        outputs = [
            TxOutput(TokenAmount.from_v1(10), b'', 0),   # HTR
            TxOutput(TokenAmount.from_v1(250), b'', 1),  # TOKEN A
            TxOutput(TokenAmount.from_v1(300), b'', 2),  # TOKEN B
        ]
        nc2 = Transaction(
            weight=1,
        ...
        nc2.headers.append(NanoHeader(
            ...
            nc_actions=[
                NanoHeaderAction(
                    ...
                    token_index=1,
                    amount=TokenAmount.from_v1(50),
                ),
                NanoHeaderAction(
                    type=NCActionType.DEPOSIT,
                    token_index=0,
                    amount=TokenAmount.from_v1(90),
                ),
            ],
        ))
        nc2.update_hash()
