...
class NCReentrancyTestCase(BlueprintTestCase):
    def setUp(self) -> None:
        ...
        assert self.target_storage.get_balance(HTR_TOKEN_UID).value == TokenAmount.from_v1(10_150).to_balance()
    ...
    def test_basics(self) -> None:
        ...
        assert self.target_storage.get_balance(HTR_TOKEN_UID).value == TokenAmount.from_v1(10_150 - 30).to_balance()
        assert self.attacker_storage.get_balance(HTR_TOKEN_UID).value == TokenAmount.from_v1(0 + 30).to_balance()
    ...
    def test_attack_succeed(self) -> None:
        ...
        assert actual_target == TokenAmount.from_v1(10_150 - self.n_calls * 50).to_balance()
        assert actual_attacker == TokenAmount.from_v1(self.n_calls * 50).to_balance()
