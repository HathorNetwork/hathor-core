...
"""Drive the real `hathor-next` protocol state machine from Python via `htr_next.ProtocolPeer`.
...
class RustProtocolDriverTest(unittest.TestCase):
    ...
    def _drive_to_ready(self) -> htr_next.ProtocolPeer:
        peer = htr_next.ProtocolPeer('unittests')
    ...
    def test_unknown_network_rejected(self) -> None:
        with self.assertRaises(ValueError):
            htr_next.ProtocolPeer('not-a-network')
