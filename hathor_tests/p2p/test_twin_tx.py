...
class TwinTransactionTestCase(unittest.TestCase):
    ...
    def test_twin_tx(self) -> None:
        ...
        outputs = [
            WalletOutputInfo(address=decode_address(address), value=TokenAmount.from_v1(int(value1)), timelock=None),
            WalletOutputInfo(address=decode_address(address), value=TokenAmount.from_v1(int(value2)), timelock=None),
        ]

        outputs2 = [
            WalletOutputInfo(address=decode_address(address), value=TokenAmount.from_v1(int(value1)), timelock=None),
            WalletOutputInfo(address=decode_address(address), value=TokenAmount.from_v1(int(value3)), timelock=None),
        ]
