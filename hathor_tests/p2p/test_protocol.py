...
class HathorProtocolTestCase(unittest.TestCase):
    ...
    def test_hello_without_ipv6_capability(self) -> None:
        ...
        manager1 = self.create_peer(
            network,
            peer=self.peer1,
            capabilities=[self._settings.CAPABILITY_WHITELIST, self._settings.CAPABILITY_IPV6,
                          self._settings.CAPABILITY_SYNC_VERSION]
        )
        manager2 = self.create_peer(
            network,
            peer=self.peer2,
            capabilities=[self._settings.CAPABILITY_WHITELIST,
                          self._settings.CAPABILITY_SYNC_VERSION]
        )
    ...
    def test_hello_with_ipv6_capability(self) -> None:
        ...
        manager2 = self.create_peer(
            ...
            peer=self.peer2,
            capabilities=[self._settings.CAPABILITY_WHITELIST,
                          self._settings.CAPABILITY_IPV6, self._settings.CAPABILITY_SYNC_VERSION]
        )
