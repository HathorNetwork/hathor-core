...
class APIVersionAmountTestCase(unittest.TestCase):
    ...
    def test_to_response_v1a_is_v1_int(self) -> None:
        self.assertEqual(APIVersion.V1A.unsigned_amount_to_response(UnsignedAmount.from_v1(0)), 0)
    ...
    def test_to_response_v2_is_18_decimal_string(self) -> None:
        self.assertEqual(APIVersion.V2.unsigned_amount_to_response(UnsignedAmount.from_v1(0)), '0.000000000000000000')
        self.assertEqual(
            APIVersion.V2.unsigned_amount_to_response(UnsignedAmount.from_v1(12345)),
    ...
    def test_from_request_v2_reads_decimal_string(self) -> None:
        self.assertEqual(
            APIVersion.V2.unsigned_amount_from_request('123.450000000000000000'),
