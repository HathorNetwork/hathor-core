    ...
    def test_success(self):
        ...
        self.assertEqual(
            ...
            {settings.HATHOR_TOKEN_UID.hex(): {
                'value': str(self.api_version.unsigned_amount_to_response(UnsignedAmount.from_v1(0))),
                'can_mint': False,
                'can_melt': False,
            }}
        )
        ...
        self.assertEqual(
            balances2,
            {settings.HATHOR_TOKEN_UID.hex(): {
                'value': str(self.api_version.unsigned_amount_to_response(UnsignedAmount.from_v1(value))),
                'can_mint': False,
                'can_melt': False,
            }}
        )
