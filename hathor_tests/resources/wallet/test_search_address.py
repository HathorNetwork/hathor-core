...
class SearchAddressTest(_BaseResourceTest._ResourceTest):
    ...
    def _check_address_balance(self, api_version):
        ...
        self.assertEqual(api_version.unsigned_amount_to_response(UnsignedAmount.from_v1(0)), htr_data['spent'])
        ...
        self.assertEqual(api_version.unsigned_amount_to_response(UnsignedAmount.from_v1(0)), token_data['spent'])
