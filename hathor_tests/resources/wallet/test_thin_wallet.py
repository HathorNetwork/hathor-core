...
class SendTokensTest(_BaseResourceTest._ResourceTest):
    ...
    def test_post(self):
        ...
        self.assertEqual(
            ...
            sum(blocks_tokens, start=TokenAmount.zero()),
        )
        ...
        o_invalid_amount = TxOutput(
            (value - TokenAmount.from_v1(1)).to_v1(),
        ...
        self.assertEqual(
            self.manager.wallet.balance[self._settings.HATHOR_TOKEN_UID].available,
            sum(blocks_tokens[:-1], start=TokenAmount.zero())
        )
...
#            yield d.request.thread_deferred
    ...
    def test_history_paginate(self):
        ...
        for i in range(tx_count):
            ...
            amount = sum(([b.outputs[0].value for b in blocks[start_index:end_index]]), start=TokenAmount.zero())
    ...
    def test_token(self):
        ...
        self.assertEqual(data['total_v2'], amount * 10**16)
    ...
    def test_token_history(self):
        ...
        output_address = decode_address(self.get_address(0))
        o = TxOutput(TokenAmount.from_v1(100), create_output_script(output_address, None), 1)
