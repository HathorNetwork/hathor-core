...
class TransactionTest(_BaseResourceTest._ResourceTest):
    ...
    def test_get_one_known_tx(self):
        ...
        tx_parent1.set_static_metadata(TransactionStaticMetadata(min_height=0, closest_ancestor_block=b'\x00' * 32))
        ...
        tx_parent2.set_static_metadata(TransactionStaticMetadata(min_height=0, closest_ancestor_block=b'\x00' * 32))
        ...
        tx_input.set_static_metadata(TransactionStaticMetadata(min_height=0, closest_ancestor_block=b'\x00' * 32))
