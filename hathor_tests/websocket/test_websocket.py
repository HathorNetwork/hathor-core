...
class WebsocketTest(_BaseResourceTest._ResourceTest):
    ...
    def test_output_received(self):
        ...
        output = UnspentTx(gen_tx.hash, 0, TokenAmount.from_v1(10), gen_tx.timestamp, '',
    ...
    def test_input_spent_received(self):
        ...
        spent = SpentTx(gen_tx2.hash, gen_tx.hash, 0, TokenAmount.from_v1(10), gen_tx.timestamp + 1)
