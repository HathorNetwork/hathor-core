...
KNOWN_CASES = [
    ...
    'hathor.nanocontracts.context.Context.fees',
    ...
    'hathor.nanocontracts.types.NCFee.amount',
    'hathor.nanocontracts.types.NCFee.get_htr_value',
    'hathor.nanocontracts.types.NCFee.some_new_attribute',
    'hathor.nanocontracts.types.NCFee.token_uid',
