...
KNOWN_CASES = [
    ...
    'hathor.nanocontracts.context.Context.copy.some_new_attribute',
    'hathor.nanocontracts.context.Context.get_single_action.some_new_attribute',
    'hathor.nanocontracts.context.Context.timestamp.fget.some_new_attribute',
    'hathor.nanocontracts.context.Context.to_json.some_new_attribute',
    'hathor.nanocontracts.context.Context.vertex.fget.some_new_attribute',
    ...
    'hathor.nanocontracts.types.NCActionType.from_bytes.some_new_attribute',
