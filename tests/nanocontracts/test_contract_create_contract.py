...
class NCBlueprintTestCase(BlueprintTestCase):
    ...
    def test_dag_basic(self):
        ...
        nc4 = artifacts.by_name['nc3'].vertex
        ...
        contracts.append(derive_child_contract_id(nc1.hash, salt1, self.blueprint1_id))
        # nc2
        contracts.append(derive_child_contract_id(nc1.hash, salt1 + b'1', self.blueprint2_id))
        contracts.append(derive_child_contract_id(nc1.hash, salt1 + b'2', self.blueprint2_id))
        contracts.append(derive_child_contract_id(nc1.hash, salt1 + b'3', self.blueprint2_id))
        # nc3
        contracts.append(derive_child_contract_id(contracts[1], salt2 + b'1', self.blueprint1_id))
        contracts.append(derive_child_contract_id(contracts[1], salt2 + b'2', self.blueprint1_id))
        contracts.append(derive_child_contract_id(contracts[1], salt2 + b'3', self.blueprint1_id))
