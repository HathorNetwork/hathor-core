...
class NCNanoContractTestCase(BlueprintTestCase):
    ...
    def test_basics(self) -> None:
        ...
        assert storage2.get('my_blueprint_id') == self.my_blueprint_id
        assert storage2.get('other_blueprint_id') == self.other_blueprint_id

    def test_authorities(self) -> None:
        nc_id = self.gen_random_nanocontract_id()
