...
class MVP_PoolBlueprintTestCase(BlueprintTestCase):
    ...
    def test_swap1_no_change(self) -> None:
        ...
        self.assertEqual(reserve_after, self.runner.call_private_method(self.nc_id, "get_reserves"))

        self.assertEqual(
            (0, 0),
            self.runner.call_private_method(self.nc_id, "balance_of", ctx.address),
        )
    ...
    def test_swap1_with_change(self) -> None:
        ...
        self.assertEqual(
            (0, change), self.runner.call_private_method(self.nc_id, "balance_of", ctx.address)
        )
        self.assertBalanceReserve(storage)
    ...
    def test_swap2_no_change(self) -> None:
        ...
        self.assertEqual(
            (0, 0), self.runner.call_private_method(self.nc_id, "balance_of", ctx.address)
        )
        self.assertBalanceReserve(storage)
    ...
    def test_swap2_with_change(self) -> None:
        ...
        self.assertEqual(
            (change, 0), self.runner.call_private_method(self.nc_id, "balance_of", ctx.address)
        )
        self.assertBalanceReserve(storage)
    ...
    def test_amount_in_out(self) -> None:
        ...
        self.assertEqual(
            20_40,
            self.runner.call_private_method(self.nc_id, "get_amount_in", 20_00, 1_000_00, 1_000_00),
        )
    ...
    def test_add_liquidity_no_change(self) -> Context:
        ...
        self.assertEqual(
            get_liquidity, self.runner.call_private_method(self.nc_id, "liquidity_of", ctx.address)
        )
    ...
    def test_remove_liquidity_no_change(self) -> Context:
        ...
        user_liquidity = self.runner.call_private_method(self.nc_id, "liquidity_of", ctx.address)
        ...
        self.assertEqual(
            ...
            self.runner.call_private_method(self.nc_id, "liquidity_of", ctx.address),
        )
        return ctx
    ...
    def test_add_swap_remove(self) -> None:
        ...
        self.assertEqual(
            (0, 0), self.runner.call_private_method(self.nc_id, "balance_of", ctx_remove.address)
        )
        self.assertBalanceReserve(storage)
        ...
        self.assertEqual(
            user_liquidity_after,
            self.runner.call_private_method(self.nc_id, "liquidity_of", ctx_remove.address),
        )
        ...
        self.assertEqual(
            ...
            self.runner.call_private_method(self.nc_id, "get_reserves"),
        )
    ...
    def test_multiple_add_and_remove_liquidity(self) -> None:
        ...
        for i in range(users):
            self.assertEqual(
                users_liquidity[i],
                self.runner.call_private_method(self.nc_id, "liquidity_of", ctx_adds[i].address),
            )
    ...
    def test_multiple_add_swap_and_remove_liquidity(self) -> None:
        ...
        for i in range(users):
            ...
            self.assertEqual(
                dev_liquidity,
                self.runner.call_private_method(self.nc_id, "liquidity_of", self.admin_address),
            )

            self.assertEqual(
                fee_accumulated,
                self.runner.call_private_method(self.nc_id, "accumulated_fee_of", self.token_a),
            )
    ...
    def test_front_end_api_pool(self) -> None:
        ...
        pool_info = self.runner.call_private_method(self.nc_id, "front_end_api_pool")
        ...
        updated_pool_info = self.runner.call_private_method(self.nc_id, "front_end_api_pool")
    ...
    def test_add_swap_remove_liquidity_random(self) -> None:
        ...
        def get_reserves():
            return self.runner.call_private_method(self.nc_id, "get_reserves")
        ...
        final_pool_info = self.runner.call_private_method(self.nc_id, "front_end_api_pool")
    ...
    def test_random_user_interactions(self):
        ...
        for _ in range(num_actions):
            ...
            if action == "add_liquidity":
                ...
                user_liquidity = self.runner.call_private_method(self.nc_id, "liquidity_of", user)
        ...
        total_user_liquidity = sum(
            self.runner.call_private_method(self.nc_id, "liquidity_of", user) for user in all_users
        )
