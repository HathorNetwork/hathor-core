...
class NCConsensusTestCase(SimulatorTestCase):
    ...
    def test_nc_consensus_voided_tx_propagation_to_blocks(self) -> None:
        ...
        tx2 = vertices.by_name['tx2'].vertex
        tx3 = vertices.by_name['tx3'].vertex
        tx4 = vertices.by_name['tx4'].vertex
        tx5 = vertices.by_name['tx5'].vertex

        self.assertIsNone(tx1.get_metadata().voided_by)
        self.assertIsNone(tx2.get_metadata().voided_by)
        self.assertEqual(tx3.get_metadata().voided_by, {tx3.hash, self._settings.NC_EXECUTION_FAIL_ID})
        self.assertEqual(tx4.get_metadata().voided_by, {tx3.hash, tx4.hash})
        self.assertIsNone(tx5.get_metadata().voided_by)

        b33 = vertices.by_name['b33'].vertex
        b34 = vertices.by_name['b34'].vertex
        b50 = vertices.by_name['b50'].vertex
