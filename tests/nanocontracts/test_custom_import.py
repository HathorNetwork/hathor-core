...
class TestCustomImport(BlueprintTestCase):
    def test_custom_import_is_used(self) -> None:
        ...
        blueprint = '''
            from hathor.contracts import Blueprint, Context, public
            ...
            class MyBlueprint(Blueprint):
                ...
                def initialize(self, ctx: Context) -> None:
                    ...
                    from hathor.contracts import NCFail, NCAction, NCActionType
        ...
        module_level_calls = [
            call('hathor.contracts', ANY, ANY, ('Blueprint', 'Context', 'public'), 0),
        ]
        ...
        method_level_imports = [
            ...
            call('hathor.contracts', ANY, ANY, ('NCFail', 'NCAction', 'NCActionType'), 0),
        ]
