...
class TokenTest(unittest.TestCase):
    ...
    def _create_token(self):
        ...
        tx = Transaction(weight=1, inputs=[_input1], parents=parents, storage=self.manager.tx_storage,
        ...
        tx2 = Transaction(weight=1, inputs=[_input1], outputs=[token_output1, token_output2,
                                                               token_output3], parents=parents, tokens=[new_token_uid],
