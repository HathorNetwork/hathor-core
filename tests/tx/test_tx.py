...
class BaseTransactionTest(unittest.TestCase):
    ...
    def test_merge_mined_no_magic(self):
        ...
        b.init_static_metadata_from_storage(self.tx_storage)
    ...
    def test_merge_mined_multiple_magic(self):
        ...
        b1.init_static_metadata_from_storage(self.tx_storage)
        b2.init_static_metadata_from_storage(self.tx_storage)
