...
class DAGBuilderTestCase(unittest.TestCase):
    ...
    def test_nc_transactions(self) -> None:
        ...
        ctx2 = tx2.get_nano_header().get_context().unwrap()
        ...
        ctx3 = tx3.get_nano_header().get_context().unwrap()
...
if foo:
    ...
    def test_on_chain_blueprints(self) -> None:
        ...
        blueprint_class = self.manager.tx_storage.get_blueprint_class(ocb1.hash).unwrap()
        ...
        blueprint_class = self.manager.tx_storage.get_blueprint_class(ocb2.hash).unwrap()
        ...
        blueprint_class = self.manager.tx_storage.get_blueprint_class(ocb3.hash).unwrap()
