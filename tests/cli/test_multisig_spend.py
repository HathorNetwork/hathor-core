...
class BaseMultiSigSpendTest(unittest.TestCase):
    ...
    def test_spend_multisig(self):
        ...
        self.assertEqual(self.manager.wallet.balance[constants.HATHOR_TOKEN_UID], WalletBalance(0, available_tokens))
        ...
        self.assertEqual(self.manager.wallet.balance[constants.HATHOR_TOKEN_UID], wallet_balance)
