...
class BaseMetricsTest(unittest.TestCase):
    ...
    def test_connections_manager_integration(self):
        ...
        manager.connections.ready_peers.update({"1": peer1, "2": peer2})
    ...
    def test_peer_connections_data_collection(self):
        ...
        manager.connections.ready_peers[fake_peers[0].peer.id] = fake_peers[0]
        manager.connections.ready_peers[fake_peers[1].peer.id] = fake_peers[1]
        manager.connections.ready_peers[fake_peers[2].peer.id] = fake_peers[2]
