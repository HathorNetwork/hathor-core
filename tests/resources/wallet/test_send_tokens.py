...
class SendTokensTest(_BaseResourceTest._ResourceTest):
    def setUp(self):
        super().setUp()
        self.web = StubSite(SendTokensResource(self.wallet_manager))
        self.web_mining = StubSite(MiningResource(self.manager))
        self.web_balance = StubSite(BalanceResource(self.wallet_manager))
        self.web_history = StubSite(HistoryResource(self.wallet_manager))
    ...
    def test_post(self):
        ...
        # Unlocking wallet
        self.wallet_manager.wallet.unlock(b"MYPASS")
