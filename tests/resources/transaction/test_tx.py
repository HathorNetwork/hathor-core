...
class TransactionTest(_BaseResourceTest._ResourceTest):
    ...
    def test_get_one_known_tx(self):
        ...
        self.manager.tx_storage.indexes.tokens._create_token_info(token_bytes1, 'Test Coin', 'TSC', TokenInfoVersion.DEPOSIT)

        token_bytes2 = bytes.fromhex('007231eee3cb6160d95172a409d634d0866eafc8775f5729fff6a61e7850aba5')
        self.manager.tx_storage.indexes.tokens._create_token_info(token_bytes2, 'NewCoin', 'NCN', TokenInfoVersion.DEPOSIT)
    ...
    def test_get_one_known_tx_with_authority(self):
        ...
        self.manager.tx_storage.indexes.tokens._create_token_info(token_bytes1, 'Wat wat', 'WAT', TokenInfoVersion.DEPOSIT)
